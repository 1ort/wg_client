...
async def CreateDevice(data: DeviceCreateOrUpdateRequest, api_config_override: Optional[APIConfig] = None) -> Device:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def GetDevice(name: str, api_config_override: Optional[APIConfig] = None) -> Device:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def DeleteDevice(name: str, api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def GetDeviceOptions(name: str, api_config_override: Optional[APIConfig] = None) -> DeviceOptions:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def GetDevicePeer(name: str, urlSafePubKey: str, api_config_override: Optional[APIConfig] = None) -> Peer:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def DeleteDevicePeer(name: str, urlSafePubKey: str, api_config_override: Optional[APIConfig] = None) -> Peer:
    api_config = api_config_override if api_config_override else APIConfig()
